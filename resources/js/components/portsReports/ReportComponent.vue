        ...
        <table class="table table-dark table-bordered table-responsive table-hover table-striped">
            <thead>
                <tr>
                    ...
                    <td>Total Failed</td>
                    <td>Total Busy</td>
                    <td>Total No Answer</td>
                    <td>Total Else Status</td>
                    <td>Bill Min</td>
                    <td>
                        Dispositions
                    </td>
                    ...
                    <td>Total Numbers Enabled</td>
                    <td>Total Numbers Disabled</td>
                    <td>Date</td>
                </tr>
            </thead>
            <template v-if="!enableDates">
                <tr v-for="port in ports" v-bind:key="port.value" id="reportSummary" 
                    ...
                    ">
                    <td>{{port.value}}</td>
                    <td @click="detailedReport('totalCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].totalCalls}}</td>
                    <td @click="detailedReport('answeredCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].answeredCalls}}</td>
                    <td @click="detailedReport('failedCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].failedCalls}}</td>
                    <td @click="detailedReport('busyCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].busyCalls}}</td>
                    <td @click="detailedReport('noAnswerCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].noAnswerCalls}}</td>
                    <td @click="detailedReport('elseCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].elseCalls}}</td>
                    <td>{{reportSummary[`cdr-${port.value}`].billmin}}</td>
                    <td @click="toggleShowDispositions(port.value)">
                        Dispositions
                    ...
                    <td @click="detailedReport('uniqueCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].uniqueCalls}}</td>
                    <!-- <td @click="detailedReport('repeatedCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].repeatedCalls}}</td> -->
                    <td @click="detailedReport('enabledNumbers', 'ROUTES', port.value)">{{reportSummary[`numbers-${port.value}`].enabledNumbers}}</td>
                    <td @click="detailedReport('disabledNumbers', 'ROUTES', port.value)">{{reportSummary[`numbers-${port.value}`].disabledNumbers}}</td>
                </tr>
            </template>
            <template v-else v-for="port in ports">
                <tr v-for="(v, k) in reportSummary[`cdr-${port.value}`]" v-bind:key="port.value+Math.random()" id="reportSummary" 
                    ...
                    ">
                    <td>{{port.value}}</td>
                    <td @click="detailedReport('totalCalls', 'CDR', port.value,false , k)">{{reportSummary[`cdr-${port.value}`][k].totalCalls}}</td>
                    <td @click="detailedReport('answeredCalls', 'CDR', port.value,false , k)">{{reportSummary[`cdr-${port.value}`][k].answeredCalls}}</td>
                    <td @click="detailedReport('failedCalls', 'CDR', port.value,false , k)">{{reportSummary[`cdr-${port.value}`][k].failedCalls}}</td>
                    <td @click="detailedReport('busyCalls', 'CDR', port.value,false , k)">{{reportSummary[`cdr-${port.value}`][k].busyCalls}}</td>
                    <td @click="detailedReport('noAnswerCalls', 'CDR', port.value,false , k)">{{reportSummary[`cdr-${port.value}`][k].noAnswerCalls}}</td>
                    <td @click="detailedReport('elseCalls', 'CDR', port.value,false , k)">{{reportSummary[`cdr-${port.value}`][k].elseCalls}}</td>
                    ...
                    <td @click="detailedReport('uniqueCalls', 'CDR', port.value,false , k)">{{reportSummary[`cdr-${port.value}`][k].uniqueCalls}}</td>
                    <!-- <td @click="detailedReport('repeatedCalls', 'CDR', port.value)">{{reportSummary[`cdr-${port.value}`].repeatedCalls}}</td> -->
                    <td @click="detailedReport('enabledNumbers', 'ROUTES', port.value,false , k)">{{reportSummary[`numbers-${port.value}`][k].enabledNumbers}}</td>
                    <td @click="detailedReport('disabledNumbers', 'ROUTES', port.value,false , k)">{{reportSummary[`numbers-${port.value}`][k].disabledNumbers}}</td>
                    <td>{{k}}</td>
                </tr>
            </template>
        </table>
