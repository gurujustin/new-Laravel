    ...
    data(){
        return { 
            ...
            formDetails : [
                ...
                {
                    name : 'Operator' , 
                    placeholder : 'Write Script Operator Name' , 
                    type : 'text' , 
                    required : true,
                    class : 'form-control',
                    column : 'Operator'
                ...
                {
                    name : 'Provider' , 
                    placeholder : 'Write Script Provider' , 
                    type : 'selectbox' ,
                    items : this.gateways,
                    show : 'name',
                    value : 'id', 
                ...
                {
                    name : 'Status' , 
                    placeholder : 'Write Script Status' , 
                    type : 'selectbox' ,
                    items : [
                        {
                            name : 'Active',
                ...
                {
                    name : 'OperatorID' , 
                    placeholder : 'Select Script Operator' , 
                    type : 'selectbox' ,
                    items : this.operators,
                    show : 'name',
                    value : 'id',
